...
将复杂技术工作整理为有温度、问题优先且自包含的汇报，并使用清晰 Markdown、有效图示、来源明确的代码和有根据的洞见。

**推荐场景**

- 将冗长或拧巴的请求整理为真实决策、核心矛盾和问题结构。
- 用短句、简单开发词汇、有效图示、来源明确的代码、清楚风险和可执行下一步解释调研或架构。

**使用示例**

```text
/understanding-first-report 先复述真实问题，画出核心矛盾和机制，
再给出一个有根据的洞见与下一步。
```
