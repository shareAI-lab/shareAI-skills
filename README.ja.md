...
複雑な技術作業を、結論優先で、図とコードの出典が明確な、理解負荷の低い報告にまとめます。

**推奨シナリオ**

- 大規模な調査やアーキテクチャレビューを、主要な矛盾と決定的証拠へ圧縮する。
- 不確実性や境界を隠さず、人間のアーキテクトへ技術判断を説明する。

**使用例**

```text
/understanding-first-report 1 つの明確なモデルと実行可能な提案で、
この調査を人間のアーキテクトへ説明してください。
```
