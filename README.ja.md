...
複雑な技術作業を、問いの整理から始める、温かく読みやすい自己完結型の報告にまとめます。明確な Markdown、意味のある図、出典付きコード、根拠ある洞察を使います。

**推奨シナリオ**

- 長く複雑な依頼を、実際の判断、中心的な矛盾、問題の構造へ整理する。
- 短い文章、一般的な開発用語、意味のある図、出典付きコード、明確なリスク、実行できる次の一歩で調査や設計を説明する。

**使用例**

```text
/understanding-first-report 本当の問いを整理し、中心的な矛盾と仕組みを図で示し、
根拠ある洞察と次の一歩を提示してください。
```
